...
static uint8_t felica_idm[]={0x02, 0xFE, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66};
static uint8_t felica_pmm[]={0x01, 0x23, 0x45, 0x67, 0x89, 0xAB, 0xCD, 0xEF};
...
void NFCF(rfalNfcfListenDevice *nfcDev){
    ...
    txBuf[0]=FELICA_READ_WITHOUT_ENCRYPTION_CMD_CODE;
